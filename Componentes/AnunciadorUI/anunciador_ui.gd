...
func mostrar_evento_interface(is_Home: bool = true, texto_lance: String = "1", cor_time: Color = Color.WHITE, duracao_deslize: float = 2.0) -> void:
	...
	lances_label.add_theme_font_size_override("font_size", 250)
	lances_label.vertical_alignment = VERTICAL_ALIGNMENT_TOP
...
func mostrar_evento_interface_match_start(is_Home: bool = true, texto: String = "1", cor_animacao: Color = Color.WHITE, duracao_deslize: float = 2.0) -> void:
	...
	lances_label.add_theme_font_size_override("font_size", 145)
...
func _avisar_fim_evento_interface_match_start() -> void:
	video_player.stop()
	lances_control.visible = false
