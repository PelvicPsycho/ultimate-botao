...
class_name PhysicsPlayer2D_Tutorial_2
...
static var last_piece_with_radial: PhysicsPlayer2D_Tutorial_2 = null
var canPlay: bool
...
var match_state: MatchState_Tutorial_2
		...
		if match_state.game_paused == false:
			...
			if is_mouse_release or is_touch_release:
				...
				if not is_pointer_inside_piece:
					Execute_Action()
					#Execute_Action_parameters(Vector2(0.999999, -0.001209), 1)
...
func Execute_Action() -> void:
	...
	#print("AAA current_force = ", current_force)
	#print("AAA current_direction = ", current_direction)
...
#AAA current_force = 1300.0
#AAA current_direction = (0.999999, -0.001209)
...
func abrir_botoes_cartas():
	...
	menu_radial.abrir()
	PhysicsPlayer2D_Tutorial_2.last_piece_with_radial = self
#endregion
