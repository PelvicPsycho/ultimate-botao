extends CanvasLayer
class_name PauseMenu_Tutorial_2

var Pecas_Jogo: Array[PhysicsPlayer2D_Tutorial_2] = []
var a_bola: PhysicsBall2D_Tutorial_2
...
func pegar_todas_pecas():
	...
	for node in nodes_pecas:
		if node is PhysicsPlayer2D_Tutorial_2:
			Pecas_Jogo.append(node as PhysicsPlayer2D_Tutorial_2)
