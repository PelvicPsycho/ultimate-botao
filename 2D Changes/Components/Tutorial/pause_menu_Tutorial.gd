extends CanvasLayer
class_name PauseMenu_Tutorial

var Pecas_Jogo: Array[PhysicsPlayer2D_Tutorial] = []
var a_bola: PhysicsBall2D_Tutorial
...
func pegar_todas_pecas():
	...
	for node in nodes_pecas:
		if node is PhysicsPlayer2D_Tutorial:
			Pecas_Jogo.append(node as PhysicsPlayer2D_Tutorial)
