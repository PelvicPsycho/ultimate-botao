extends Node
class_name MatchState_Tutorial

enum turn {HOME, AWAY}
signal turno_trocado(turno_atual: turn)

@export var physics_controller: CollisionResolution2D_Tutorial
...
var allPieces: Array[PhysicsPlayer2D_Tutorial]
var selectedPiece: PhysicsPlayer2D_Tutorial
...
func onClickedPiece(piece: PhysicsPlayer2D_Tutorial) -> void:
...
func _on_lance_acabou() -> void: 
	...
	var peca_arrastada: PhysicsPlayer2D_Tutorial = null
...
func tentar_usar_carta(piece: PhysicsPlayer2D_Tutorial, carta: CardResource) -> void:
	if carta_usada_no_turno:
		return
...
func _on_player_clicked_piece(Piece: PhysicsPlayer2D_Tutorial) -> void:
	if carta_usada_no_turno:
		return
